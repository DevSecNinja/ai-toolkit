...
description: |
  Blocks focus time on my calendar based on my preferences
cowork:
...
- Create the Focus Time blocks with title "Focus Time" and set it as "Busy". Make sure to check any Focus Time blocks already created that day and take those hours into account.