...
<!--
  Adapted from github/awesome-copilot (workflows/relevance-check.md, MIT License),
  pinned at commit 3e36d367091a1e67b77974cade6f1aa48bc77a81.

  This is a GitHub Agentic Workflow (gh-aw), NOT an APM primitive — gh-aw `.md`
  files cannot be installed via `apm install`. It lives in `.github/workflows/`
  and must be compiled before it runs:

      gh extension install github/gh-aw
      gh aw compile

  `gh aw compile` generates the runnable `.github/workflows/relevance-check.lock.yml`.
  Copy this file into any repo where you want `/relevance-check` issue/PR triage
  (e.g. high-backlog repos like truenas-apps, dotfiles, home-assistant-config).
-->
